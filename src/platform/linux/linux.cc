...
void LinuxPlatform::setIcon(const sf::WindowHandle& inHandle) { UNUSED(inHandle); }

void LinuxPlatform::toggleFullscreen(const sf::WindowHandle& inHandle, const sf::Uint32 inStyle,
